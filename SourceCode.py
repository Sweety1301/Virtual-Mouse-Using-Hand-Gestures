...
#2. setting up mouse controller
mouse = Controller()
#3. getting screen dimensions
screen_width, screen_height = pyautogui.size()
#4. inilizing mediapipe handles
...
#6. moving the mouse
def move_mouse(inder_finegr_tip):
  if index_finger_tip is not None:
    x = int(index_finger_tip.x * screen_width)
    y = int(index_finger_tip.y * screen_height)
    pyautogui.moveTo(x,y)

#7. Gesture Detection(CLICK ACTIONS)
#Left Click
...
#8. Main Gesture Detection Function
